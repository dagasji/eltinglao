<?php
    ...
    if($metodo == 'nuevo' && $descripcion != '' && $carpeta != ''){        
        $INSERT = "INSERT INTO tipo_banda (descripcion, carpeta) " .
    ...
    if($metodo == 'modificar' && $descripcion != '' && $carpeta != ''){
        ...
        $UPDATE = "UPDATE tipo_banda SET descripcion = '$descripcion'"
    ...
    if($metodo == 'delete' && $id != ''){
        ...
        $DELETE = "DELETE FROM tipo_banda WHERE id_tipo = $id";
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es_ES" xml:lang="es_ES">
    ...
    <body>
        <div id="container">
            ...
            <div id="main">
                <h4>Tipos de Bandas</h4>                
                <table border="0">
                    <tr>
                        <td style="width:80px"><b>C&oacute;digo</b></td>
                ...
                <h4>Detalle</h4>
                <form name="formulario" method="post" action="adminTB.php"  onSubmit="return validar()">
